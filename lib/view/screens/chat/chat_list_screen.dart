    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: chatProWatch.isSelectionMode
            ? AppBar(
                title: Text(
                  '${chatProWatch.selectedUserIds.length} selected',
                      ...
                      chatList.isEmpty
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final isSelected = chatProWatch.selectedUserIds
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          AppRoutes.push(context, SearchScreen(toChat: true));
        },
        child: Material(
          elevation: 3,
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(width: 10),
                Text('Search...', style: StringStyle.normalTextBold()),
              ],
            ),
          ),
        ),
...
class ListEmptySection extends StatelessWidget {
