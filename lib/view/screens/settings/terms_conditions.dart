      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            _buildBulletPoint("Any activity conducted through your account is your responsibility. Notify us immediately of unauthorized access or breaches."),
            _buildSectionTitle("3. Acceptable Use"),
            _buildBulletPoint("Use the platform for lawful purposes, including networking, academic collaboration, and personal expression."),
            _buildBulletPoint("Refrain from sharing content that is abusive, hateful, explicit, defamatory, or violates intellectual property rights."),
            _buildBulletPoint("Avoid spamming, phishing, or engaging in any fraudulent activities."),
            ...
            _buildBulletPoint("By posting content on STUEDIC, you grant us a non-exclusive, royalty-free license to use, modify, and distribute your content for platform-related purposes."),
            _buildBulletPoint("You retain ownership of your content but agree not to upload anything that infringes on third-party rights or violates laws."),
            _buildSectionTitle("6. Prohibited Activities"),
            _buildBulletPoint("Use bots, scripts, or automated tools to scrape data or disrupt the platform."),
            _buildBulletPoint("Misuse the app for unauthorized advertising or promotions."),
            _buildBulletPoint("Engage in cyberbullying, harassment, or impersonation of others."),
