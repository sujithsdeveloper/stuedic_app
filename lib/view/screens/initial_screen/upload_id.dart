...
class IDUpload extends StatefulWidget {
  const IDUpload({super.key, required this.nextPage});
                ...
                children: [
                  ...
                  proWatchML.isLoading
                      ...
                      : GestureDetector(
                          ...
                          child: Opacity(
                            opacity: proWatchML.isVerified ? 0.5 : 1,
                            child: Container(
                              height: 36,
                              width: 122,
                              decoration: BoxDecoration(
                                ...
                                color: proWatchML.isContinue
                                    ...
                                    : Colors
                                        .grey, // Grey when conditions are not met
                              ),
                              child: Center(
                                child: Text(
                                    proWatchML.isVerified
                                        ? 'Verified'
                                        : 'Verify',
                                    style: StringStyle.normalText(
                                        color: Colors.white)),
                  ...
                  GradientButton(
                    label: proWatchML.isVerified ? "Continue" : 'Maybe later',
                    width: double.infinity,
                    onTap: () {
                      widget.nextPage();
                    },
